...
def load_md_args(parser):
    ...
    parser.add_argument("-id", type=str, default="None", help="Loads PDB_CHAIN_ID as input from either command line interface or list.txt")
    ...
    parser.add_argument("-o", type=str, default="None", help="Output folder. If not provided, a new folder will be created in the current directory.")
    ...
    return [pdc, n_resize, filt, verbose, traj, topo, at_sel, feat, pca, c_section, pdb_chain_id, output_dir]
